...
public class TreandingMovies extends HttpServlet 
{
	private static final String TMDB_API_KEY = "e4fab66da9f615c07892ead6b42a792f"; 
    private static final String TMDB_API_BASE_URL = "https://api.themoviedb.org/3/trending/movie/";

    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        
        // Get the time window parameter from the request (default to "day" if not provided)
        String timeWindow = request.getParameter("time_window");
        if (timeWindow == null || (!timeWindow.equals("day") && !timeWindow.equals("week"))) {
            timeWindow = "day";  // Default to "day"
        }

        String apiUrl = TMDB_API_BASE_URL + timeWindow + "?api_key=" + TMDB_API_KEY;
