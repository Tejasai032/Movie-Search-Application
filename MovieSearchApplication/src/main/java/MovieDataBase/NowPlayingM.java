...
public class NowPlayingM extends HttpServlet 
{
	private static final String TMDB_API_KEY = "e4fab66da9f615c07892ead6b42a792f"; 
    private static final String TMDB_API_BASE_URL = "https://api.themoviedb.org/3/movie/now_playing?api_key=" + TMDB_API_KEY;
...
protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (responseCode == HttpURLConnection.HTTP_OK) { 
            ...
            htmlResponse.append("<div class=\"view\">");
            htmlResponse.append(" <div class=\"mgenre\" id=\"show\">");
            htmlResponse.append(" <h2><a style=\"font-size: 18px;\" href=\"NowPlayingM\">Now Playing</a></h2>");
            htmlResponse.append(" <h2><a style=\"font-size: 18px;\" href=\"TreandingMovies\">Trending Movies</a></h2>");
            htmlResponse.append(" <h2><a style=\"font-size: 18px;\" href=\"UpComingM\">Upcoming</a></h2>");
            htmlResponse.append(" </div>");
            htmlResponse.append("    <div class=\"Tvgenre\" id=\"display\">");
            htmlResponse.append("       <h2><a style=\"font-size: 18px;\" href=\"PopularTv\">Popular</a></h2>");
            htmlResponse.append("       <h2><a style=\"font-size: 18px;\" href=\"TopRatedTv\">Top Rated</a></h2>");
            htmlResponse.append("       <h2><a style=\"font-size: 18px;\" href=\"OnTheAirTv\">On The Air</a></h2>");
            htmlResponse.append("    </div>");
            htmlResponse.append("</div>");
