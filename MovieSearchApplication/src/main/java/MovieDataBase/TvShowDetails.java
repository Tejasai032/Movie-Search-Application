...
public class TvShowDetails extends HttpServlet 
{
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
        ...
        String apiUrl = "https://api.themoviedb.org/3/tv/" + movieId + "?api_key=" + TMDB_API_KEY;
        ...
        if (responseCode == HttpURLConnection.HTTP_OK) { 
            ...
            String releaseDate = escapeHtml(getJsonString(movie, "first_air_date"));
